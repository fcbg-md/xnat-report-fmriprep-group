...
# generate_figures(all_tables, repetition_times, 'csf', reportlets_dir)
# generate_figures(all_tables, repetition_times, 'white_matter', reportlets_dir)
...
# generate_figures(all_tables, repetition_times, 'framewise_displacement', reportlets_dir)
# generate_figures(all_tables, repetition_times, 'std_dvars', reportlets_dir)
# generate_figures(all_tables, repetition_times, 'rmsd', reportlets_dir)
